...
impl I18N {
    ...
    pub fn get(&self, key: LangKey) -> String {
        match key {
            ...
            LangKey::UseSsh => self.get_lang("USE_SSH"),
            LangKey::SshHost => self.get_lang("SSH_HOST"),
            LangKey::SshPort => self.get_lang("SSH_PORT"),
            LangKey::SshUser => self.get_lang("SSH_USER"),
            LangKey::SshPassword => self.get_lang("SSH_PASSWORD"),
            LangKey::SshKey => self.get_lang("SSH_KEY"),
            LangKey::SshKeyPath => self.get_lang("SSH_KEY_PATH"),
